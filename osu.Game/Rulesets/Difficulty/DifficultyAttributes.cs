...
namespace osu.Game.Rulesets.Difficulty
{
    ...
    public class DifficultyAttributes
    {
        ...
        protected const int ATTRIB_ID_CONSISTENCY_FACTOR = 43;
        protected const int ATTRIB_ID_MECHANICAL_DIFFICULTY = 45;
        protected const int ATTRIB_ID_RHYTHM_DIFFICULTY = 47;
        protected const int ATTRIB_ID_READING_DIFFICULTY = 49;
