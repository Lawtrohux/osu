...
namespace osu.Game.Rulesets.Taiko.Difficulty
{
    public class TaikoDifficultyCalculator : DifficultyCalculator
    {
        ...
        protected override DifficultyAttributes CreateDifficultyAttributes(IBeatmap beatmap, Mod[] mods, Skill[] skills, double clockRate)
        {
            ...
            double strainRating = 0.5 * rawStrain(colour, rhythm, stamina, staminaPenalty);
            double skillsRating = 1.4 * Norm(1.5, colourRating, rhythmRating, staminaRating);

            double starRating = skillsRating + strainRating;
        ...
        /// </remarks>
        private double rawStrain(Colour colour, Rhythm rhythm, Stamina stamina, double staminaPenalty)
        {
